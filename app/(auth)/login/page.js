      ...
      <section className="bg-secoundry w-[25rem]  rounded-lg p-10">
        ...
        <div>
          <form onSubmit={handleOnSubmit}>
            ...
            <button type="submit" className="bg-blue-800 py-2 w-full px-7 text-xl rounded-lg my-3 focus:ring-2 focus:ring-blue-700 hover:bg-blue-900 font-bold disabled:bg-gray-700" disabled={disabled} >Log in</button>
          </form>
